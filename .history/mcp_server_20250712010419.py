...
async def initialize_services():
    """서비스 초기화"""
    global vector_service, enhancement_service, file_indexing_service, fast_indexing_service, analytics_service, feedback_service, langchain_rag_service, file_watcher_service, _services_initialized
...
async def network_project_upload(
    ...
    IGNORE_DIRECTORIES = {
        ...
        'chroma_db', '.history', '.vs', '.DS_Store', '.sass-cache',
        '.gradle', '.maven', 'node_modules', 'coverage', 'nyc_output'
    }
    ...
    for root, dirs, files in os.walk(project_path):
        ...
        # 현재 경로에 .으로 시작하는 디렉토리가 포함되어 있으면 건너뛰기
